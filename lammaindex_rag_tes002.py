...
# =============================================================================
# General KB answer formatting
# =============================================================================

def build_general_answer_template(
    raw_answer: str,
    ...
    for c in citations[:8]:
        ...
        source_lines.append(
            f"[{c['rank']}] {label} | score={score_text}\n"
            f"    {preview}"
        )

    if not source_lines:
        source_lines = ["No page-level source nodes returned."]
...
class RoutedKnowledgeBaseEN:
    ...
    def build(self, documents: List[Document]):
        ...
        chroma_collection = chroma_client.get_or_create_collection("routed_kb_collection_en")
    ...
    def answer(
        ...
        pretty_answer = build_general_answer_template(
...
def main():
    ...
    print("[3] Build Routed Knowledge Base (English)...")
    kb = RoutedKnowledgeBaseEN()
    kb.build(documents)
    ...
    print_result(r1)
    save_result_json(r1, "kb_answer_en_01_router_summary_like.json")
    ...
    print_result(r2)
    save_result_json(r2, "kb_answer_en_02_router_detail_like.json")
    ...
    print_result(r3)
    save_result_json(r3, "kb_answer_en_03_summary_only.json")
    ...
    print_result(r4)
    save_result_json(r4, "kb_answer_en_04_detail_filtered_pages.json")
